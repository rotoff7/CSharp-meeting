...
bool RowsToColumnsCheck(int[,] array2D)
{
    return array2D.GetLength(0) == array2D.GetLength(1);
}

//Как я придумал.
// void RowsToColumnsSwap(int[,] array2D)
// {
...
if (RowsToColumnsCheck(matrix) == true)
{
    RowsToColumnsSwap(matrix);
    Console.WriteLine("Измененный массив:");
    PrintMatrix(matrix);
}
else Console.WriteLine("Свап столбцов на строки невозможен.");